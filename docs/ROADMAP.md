...
- **Phase 6 — Enterprise Governance**: full audit timeline UI, a real
  cryptographic immutable audit hash-chain (see §1), version history on
  records, soft delete, a formal approval workflow beyond single-step
  approve/lock, compliance report generation.
