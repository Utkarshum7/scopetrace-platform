...
![Tests](https://img.shields.io/badge/tests-1039%20passing-2ebb72)
...
| Suite | Count | Notes |
| :--- | :--- | :--- |
| **Backend** | **944** tests | Run against real **PostgreSQL 16 + Redis 7** service containers in CI — not SQLite/eager-mode |
| **Frontend** | **95** tests | Vitest + React Testing Library |
| **Total** | **1,039** | Green on every commit across 4 GitHub Actions workflows |
...
| :---: | :---: | :---: |
| ![Dashboard](docs/BSI3.png) | ![Upload](docs/BSI1.png) | ![Ledger](docs/BSI2.png) |
| Real-time overview of ESG metrics, emission summaries, approval status, and ingestion statistics | Upload CSV and JSON datasets through a streamlined ingestion workflow with validation and processing status tracking | Review, approve, and track emission records with audit history and anomaly detection insights |
